    ...
    >
      ...
      <form className="flex flex-col my-10" onSubmit={onSubmit}>
        ...
        <input
          ...
          className="bg-amber-500 rounded-md p-2 text-white font-bold hover:bg-white hover:text-amber-500 hover:border-amber-500 border-2"
        />
        {hasError && (
          <span className="text-sm max-w-56 mx-auto text-red-600 font-bold">
            {isRegistering
              ? "A user with those credentials may already exist"
